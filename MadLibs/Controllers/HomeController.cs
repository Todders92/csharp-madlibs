...
namespace MadLib.Controllers
{
  public class HomeController : Controller
  {
    ...
    [Route("/madlib1")]
    public ActionResult MadLib1(string person1, string person2, string animal, string exclamation, string noun1, string noun2, string noun3, string noun4, string noun5, string adjective1, string adjective2, string adjective3, string adjective4, string adjective5, string verb1, string verb2, string adverb1)
    {
    ...
    [Route("/madlib2")]
    public ActionResult MadLib2(string person1, string person2, string animal, string exclamation, string noun1, string noun2, string noun3, string noun4, string noun5, string adjective1, string adjective2, string adjective3, string adjective4, string adjective5, string verb1, string verb2, string adverb1)
    {
      MadLibVariable newMadLib = new MadLibVariable();
      newMadLib.Person1 = person1;
      newMadLib.Person2 = person2;
